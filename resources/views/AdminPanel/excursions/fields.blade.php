@isset($excursion)
    @method('PUT')
    <input type="hidden" value="{{ $excursion->id }}" name="id">
@endisset
@csrf
    ...
    <div class="tab-content mt-5" id="myTabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[title]"
                                ...
                                placeholder="{{ __('lang.title') }}" value="{{isset($excursion)? $excursion->getTranslation($name)->title : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[description]" class="summernote"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.description') }}">{{ isset($excursion)? $excursion->getTranslation($name)->description : '' }} </textarea>
                            <div
        ...
        <div class="fv-row mb-10 fv-plugins-icon-container">
            ...
            <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                ...
                <div class="image-input-wrapper w-125px h-125px" @isset($excursion->image)
                    style='background-image:url({{$excursion->image}})'@endisset>
                </div>

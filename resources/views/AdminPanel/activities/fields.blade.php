                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type='text' name="{{$name}}[title]"
                                ...
                                placeholder="{{ __('lang.title') }}" value="{{isset($activity)? $activity->getTranslation($name)->title : '' }}">
        ...
        <div class="row mb-6">
            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    <!--begin::Col-->
                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                        <select id="kt_select2_3" class="js-example-basic form-control select2" name="facility_id">
                            @isset($activity)
                            <option value="{{ $activity->facility->id }}">{{ $activity->facility->title }}</option>
                            @endisset

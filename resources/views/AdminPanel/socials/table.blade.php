...
<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
    ...
    <thead>
        <tr class="fw-6 fw-semibold text-gray-600">
            ...
            <th class="min-w-250px">{{ __('lang.link') }}</th>
    ...
    <tbody>
        @foreach ($socials as $social)
            <tr>
                <td>
                    <span class="badge badge-light-success fs-7 fw-bold"><i class="{{ $social->icon }}"></i></span>
                </td>
                <td>
                    <span class=" fs-7 fw-bold">{{ $social->link }}</span>
                </td>
                <td>

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="icon"
                                ...
                                value="{{ $social->icon ?? '' }}" placeholder="{{__('lang.icon')}}">
                            <div
            ...
            <div class="row mb-6">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="link" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                value="{{ $social->link ?? '' }}" placeholder="{{__('lang.link')}}">

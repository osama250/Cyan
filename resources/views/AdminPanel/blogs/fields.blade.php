...
<div class="card-body border-top p-9">
    ...
    <div class="tab-content mt-5" id="myTabContent">
        ...
        <div class="tab-pane fade {{(LaravelLocalization::getCurrentLocale() == $name) ? 'show active':''}}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="{{ $name }}[title]"
                                ...
                                value="{{ isset($blog)? $blog->getTranslation($name)->title : '' }}" placeholder="{{__('lang.title')}}">
                            <div
            ...
            <div class="row mb-3">
                <!--begin::Label-->
                <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('lang.brief') }}</label>
                <!--end::Label-->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <!--begin::Col-->
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[brief]" 
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.brief') }}">{{ isset($blog)? $blog->getTranslation($name)->brief : '' }} </textarea>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <textarea name="{{$name}}[description]" class="summernote"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                placeholder="{{ __('lang.description') }}">{{ isset($blog)? $blog->getTranslation($name)->description : '' }} </textarea>
                            <div
                                class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="{{ $name }}[seo]"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                value="{{ isset($blog)? $blog->getTranslation($name)->seo : '' }}" placeholder="{{__('lang.seo')}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="{{ $name }}[keywords]"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                value="{{ isset($blog)? $blog->getTranslation($name)->keywords : '' }}" placeholder="{{__('lang.keywords')}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="{{ $name }}[focus_keyword]"
                                class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                value="{{ isset($blog)? $blog->getTranslation($name)->focus_keyword : '' }}" placeholder="{{__('lang.focus_keyword')}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <!--end::Col-->
        ...
        <div class="fv-row mb-10 fv-plugins-icon-container">
            ...
            <div class="image-input image-input-empty image-input-outline image-input-placeholder" data-kt-image-input="true">
                ...
                <div class="image-input-wrapper w-125px h-125px" @isset($blog->photo)
                    style='background-image:url({{$blog->photo}})'@endisset>
                </div>

                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="text" name="{{ $name }}[title]"
                                ...
                                value="{{ isset($cancel)? $cancel->getTranslation($name)->title : '' }}" placeholder="{{__('lang.title')}}">
                            <div
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row">
                            <!--begin::Col-->
                            <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                <textarea name="{{$name}}[content]" class="summernote"
                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 "
                                    placeholder="{{ __('lang.content') }}">{{ isset($cancel)? $cancel->getTranslation($name)->content : '' }} </textarea>
                                <div
                                    class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                                </div>
                            </div>

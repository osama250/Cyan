...
<div class="card-body border-top p-9">
            ...
            <div class="row mb-6">
                <!--begin::Label-->
                <label class="col-lg-4 col-form-label required fw-semibold fs-6">{{ __('lang.coupon_name') }}</label>
                <!--end::Label-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <input type="number" step="1" name="value" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                value="{{ $coupon->value ?? '' }}" placeholder="{{__('lang.value')}}">
                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback">
                            </div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 fv-row fv-plugins-icon-container">
                            <select class="form-select form-select-solid " data-control="select2" data-hide-search="true"
                                ...
                                <option value="1" data-select2-id="select2-data-74-kng8" {{isset($coupon) && $coupon->type =='1'?
                                    'selected':''}} >{{__('lang.amount')}}</option>
                                <option value="2" data-select2-id="select2-data-131-9yfh" {{isset($coupon) && $coupon->type =='2'?
